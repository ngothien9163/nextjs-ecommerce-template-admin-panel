      ...
      >
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            {/* Title Section */}
            <div style={{ marginBottom: "8px", padding: "4px", background: "#f6ffed", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#52c41a" }}>📝 Tiêu Đề & URL</Title>
              <Row gutter={16}>
                <Col span={24}>
                  <Form.Item
                    label={
                      ...
                      <div>
                        ...
                        {pageUrl && (
                          <span style={{ color: '#666', fontSize: '12px' }}>
                            URL trang: <code>{import.meta.env.VITE_PUBLIC_SITE_URL || 'https://example.com'}{pageUrl}</code>
                          </span>
                        )}
                      </div>
                    }
            ...
            {/* Summary Section */}
            <div style={{ padding: "4px", background: "#f0f9ff", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#13c2c2" }}>📋 Tóm Tắt Nội Dung</Title>
              <Form.Item
                label={
                  <Space>
                    <span>Tóm tắt</span>
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            <div style={{ padding: "4px", background: "#e6fffb", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#13c2c2" }}>✍️ Soạn Thảo Nội Dung</Title>
              <Form.Item
                label={
                  <Space>
                    <span>Nội dung</span>
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            <div style={{ padding: "4px", background: "#f9f0ff", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#722ed1" }}>👥 Phân Loại & Thông Tin Tác Giả</Title>
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    label={
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            ...
            <div style={{ marginBottom: "8px", padding: "4px", background: "#fff7e6", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#fa8c16" }}>🖼️ Ảnh Đại Diện</Title>
              <Row gutter={16}>
                <Col span={24}>
                  <Form.Item
                    label={
            ...
            <div style={{ padding: "4px", background: "#f0f9ff", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#13c2c2" }}>📊 Thống Kê Đọc</Title>
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    label={
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            ...
            <div style={{ marginBottom: "8px", padding: "4px", background: "#fff1f0", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#f5222d" }}>📝 Trạng Thái Xuất Bản</Title>
              <Row gutter={16}>
                <Col span={24}>
                  <Form.Item
                    label={
            ...
            <div style={{ padding: "4px", background: "#f6ffed", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#52c41a" }}>⭐ Tùy Chọn Hiển Thị</Title>
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    label={
        ...
        >
          <Card style={{ border: 'none', boxShadow: 'none' }}>
            <div style={{ padding: "4px", background: "#fff2f0", borderRadius: "8px" }}>
              <Title level={5} style={{ marginBottom: "4px", color: "#f5222d" }}>⏰ Lên Lịch Xuất Bản</Title>
              <Form.Item
                label={
                  <Space>
