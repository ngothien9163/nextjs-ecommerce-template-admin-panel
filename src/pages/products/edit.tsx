      ...
      <Form {...formProps} layout="vertical">
        ...
        <Card title="Thông tin cơ bản" style={{ marginBottom: "24px" }}>
          ...
          <Row gutter={16}>
            <Col span={12}>
              ...
              >
                <Select placeholder="Chọn danh mục" {...categorySelectProps} />
              </Form.Item>
            </Col>
            <Col span={12}>
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item label="Ảnh đại diện ID" name="featured_image_id">
        ...
        <Card title="Thông tin kho hàng" style={{ marginBottom: "24px" }}>
          ...
          <Row gutter={16}>
            ...
            <Col span={12}>
              <Form.Item label="Kích thước (JSON)" name="dimensions">
        ...
        <Card title="Bảo hành & Đổi trả" style={{ marginBottom: "24px" }}>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Thời hạn bảo hành" name="warranty">
            ...
            <Col span={12}>
              <Form.Item label="Chính sách đổi trả" name="return_policy">
        ...
        <Card title="Thông tin SEO" style={{ marginBottom: "24px" }}>
          <Row gutter={16}>
            <Col span={12}>
              <Form.Item label="Meta Title" name={["seo_data", "page_title"]}>
