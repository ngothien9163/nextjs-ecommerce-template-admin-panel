...
-- =====================================================
INSERT INTO medias (file_name, file_path, file_url, alt_text, title, meta_description, meta_keywords, caption, credit, license, file_size, mime_type, dimensions) VALUES
...
('Laptop', 'laptops', 'Laptop gaming, văn phòng, sinh viên chất lượng cao', (SELECT id FROM medias WHERE file_name = 'macbook-pro-hero.jpg' LIMIT 1), 0, true, 1),
('Smartphone', 'smartphones', 'Điện thoại thông minh từ các thương hiệu uy tín', (SELECT id FROM medias WHERE file_name = 'iphone-15-hero.jpg' LIMIT 1), 0, true, 2),
...
('Công nghệ', 'cong-nghe', 'Tin tức và xu hướng công nghệ mới nhất', (SELECT id FROM medias WHERE file_name = 'blog-tech-trends.jpg' LIMIT 1), '#3B82F6', 1),
('Đánh giá sản phẩm', 'danh-gia-san-pham', 'Đánh giá chi tiết các sản phẩm công nghệ', (SELECT id FROM medias WHERE file_name = 'blog-iphone-review.jpg' LIMIT 1), '#10B981', 2),
...
((SELECT id FROM medias WHERE file_name = 'iphone-15-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'iphone-15-pro' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'macbook-pro-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'macbook-air-m1' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'macbook-pro-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'macbook-pro-m2' LIMIT 1), 'primary', 1, true),

-- Quan hệ với categories
((SELECT id FROM medias WHERE file_name = 'iphone-15-hero.jpg' LIMIT 1), 'category', (SELECT id FROM categories WHERE slug = 'smartphones' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'macbook-pro-hero.jpg' LIMIT 1), 'category', (SELECT id FROM categories WHERE slug = 'laptops' LIMIT 1), 'primary', 1, true),

-- Quan hệ với blog_categories
((SELECT id FROM medias WHERE file_name = 'blog-tech-trends.jpg' LIMIT 1), 'blog_category', (SELECT id FROM blog_categories WHERE slug = 'cong-nghe' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'blog-iphone-review.jpg' LIMIT 1), 'blog_category', (SELECT id FROM blog_categories WHERE slug = 'danh-gia-san-pham' LIMIT 1), 'primary', 1, true),

-- Quan hệ với blog_posts
((SELECT id FROM medias WHERE file_name = 'blog-tech-trends.jpg' LIMIT 1), 'blog_post', (SELECT id FROM blog_posts WHERE slug = 'xu-huong-cong-nghe-2024-ai-5g-iot' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'blog-iphone-review.jpg' LIMIT 1), 'blog_post', (SELECT id FROM blog_posts WHERE slug = 'danh-gia-iphone-15-pro-co-dang-mua-khong' LIMIT 1), 'primary', 1, true),

-- Quan hệ với products mới
((SELECT id FROM medias WHERE file_name = 'ipad-pro-12-9-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'ipad-pro-12-9' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'samsung-galaxy-tab-s9-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'samsung-galaxy-tab-s9' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'airpods-pro-2-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'airpods-pro-2' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'samsung-galaxy-watch-6-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'samsung-galaxy-watch-6' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'macbook-pro-m3-max-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'macbook-pro-m3-max' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'dell-xps-13-plus-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'dell-xps-13-plus' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'iphone-15-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'iphone-15' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'google-pixel-8-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'google-pixel-8' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'sony-wh-1000xm5-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'sony-wh-1000xm5' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'nintendo-switch-oled-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'nintendo-switch-oled' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'dji-mini-3-pro-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'dji-mini-3-pro' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'gopro-hero-11-black-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'gopro-hero-11-black' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'microsoft-surface-pro-9-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'microsoft-surface-pro-9' LIMIT 1), 'primary', 1, true),
((SELECT id FROM medias WHERE file_name = 'oneplus-11-hero.jpg' LIMIT 1), 'product', (SELECT id FROM products WHERE slug = 'oneplus-11' LIMIT 1), 'primary', 1, true);
